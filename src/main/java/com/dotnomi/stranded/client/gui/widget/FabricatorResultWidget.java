...
public class FabricatorResultWidget extends ClickableWidget {
  ...
  private static final int U = 338;
  private static final int V = 49;

  private final TextRenderer textRenderer;
  private ItemStack itemStack;

  public FabricatorResultWidget(int x, int y, ItemStack itemStack) {
  ...
  protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
    ...
    context.drawItem(itemStack, getX() + 5, getY() + 5);
    drawIngredientInfo(context, getX() + 4, getY() + 4);
  }
